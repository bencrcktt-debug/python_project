...
from shared_search_state import norm_name
from src.page_bundles import ensure_cols
    ...
    for overlap in overlap_subdivisions.itertuples(index=False):
        ...
        if subdivision_type in prepared_overlap_pools:
            ...
            if subdivision_type not in pool_cache:
                ...
                pool_cache[subdivision_type] = prepare_subdivision_match_pool(base_pool, subdivision_type)
