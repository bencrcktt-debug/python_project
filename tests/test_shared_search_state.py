...
def test_build_app_state_materializes_shared_indices(app_state: search_state.AppState) -> None:
    ...
    assert app_state.initial_to_short[search_state._last_first_initial_key("Charles Abbott")] == "ABBOTT C"
...
def test_resolve_lobbyshort_from_wit_honors_session_scope(sample_workbook: dict[str, object]) -> None:
    resolved, suggestions = search_state.resolve_lobbyshort_from_wit("Abbott", sample_workbook["Wit_All"], "89R")
